...
def testing(name=None):
	...
	for quote in data:
		...
		quotes['quotes'][quote[0]] = {'part_number': quote[2], 'quantity': quote[10], 'total_price': quote[11], 'quote': quote[0], 'status': quote[3], 'quoted_by': quote[1], 'date': quote[7], 'reference': quote[8]}
