...
def rep_report(name=None):
	...
	return render_template('generic_table.html', rows = job_list, head = ['Job', 'Total Price', 'Customer', 'Shipped Date'], title = '{1} Jobs Shipped {2} - {3}', body = 'Total Sales: {0}'.format(total_sales, rep, from_date, to_date), rep_list = rep_list)
