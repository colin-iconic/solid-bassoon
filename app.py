...
def search(name=None):
	...
	#get data from quote
	cursor.execute("select comment, description, ext_description, line, note_text, part_number, quote, quote_by, reason, reference, type from quote where  comment like '%{0}%' or description like '%{0}%' or ext_description like '%{0}%' or line like '%{0}%' or note_text like '%{0}%' or part_number like '%{0}%' or quote like '%{0}%' or quoted_by like '%{0}%' or reason like '%{0}%' or reference like '%{0}%' or type like '%{0}%'".format(search))
